...
def compute_1RDM(mol, guess="CISD", func="Muller", disp=0, epsi = 1e-6, Maxiter=100, 
                 hess_approx="exa", file="close_hess", cond='xtol' ):
    """
    Parameters
    ----------
    ...
    return Compute_1RDM.Optimize_1RDM(func, hess_approx, file, cond,
                                n, no, ne, Enuc, overlap, elec1int, elec2int,
                                disp, epsi, Maxiter)
        



def rdm_guess (mol,  beta=0.4):
