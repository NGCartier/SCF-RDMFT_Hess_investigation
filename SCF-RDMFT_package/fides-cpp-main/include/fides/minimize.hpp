...
using cost_function_t = std::function<cost_fun_ret_t(DynamicVector<double>,DynamicVector<double>, void*,bool)>;
...
class Optimizer
{
  public:
     ...
     * @param f_data Arguments to pass to cost_function
     * every iteration
     */
